...
usePageSeo({
  ...
  description:
    '河南星联互动科技北斗安心联车辆监控管理平台，支持JT/T808、JT/T809、JT/T1078协议，提供实时定位、历史轨迹、实时视频、视频回放、围栏报警、数据大屏与ADAS/DSM主动安全，广泛适配物流、客运、工程车等车队监管场景，助力企业合规运营、降本增效与数字化管理，支持免费试用与源码定制交付。',
  keywords:
