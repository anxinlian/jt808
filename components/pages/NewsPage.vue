...
useHead(() => {
  ...
  const descriptionBase =
    selectedCategory.value === '更新日志'
      ...
      : selectedCategory.value === '行业动态'
        ? '北斗安心联行业动态聚焦物流、客运、景区大巴等车联网营运监管与落地案例，报道智慧交通展会、客运主动安全、北斗监控规模化应用及战略合作进展，为车队管理者与监管单位提供行业趋势洞察、政策解读与真实项目实践经验参考，助力营运安全合规、风险防控与数字化监管决策能力提升，资讯持续发布。'
        : selectedCategory.value === '产品文档'
  ...
  const keywordsBase =
    selectedCategory.value === '更新日志'
      ...
      : selectedCategory.value === '行业动态'
        ? '车联网行业动态,营运安全,客运监控,北斗监管,智慧交通,落地案例,景区大巴,星联互动,安心联'
        : selectedCategory.value === '产品文档'
